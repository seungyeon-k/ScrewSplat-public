...
import sys
from scene import Scene, ArticulatedScene, GaussianModel
...
def training(gaussians, 
    ...
    # sparse adam and depth loss setting 
...
def training_report(tb_writer, iteration, Ll1, loss, l1_loss, elapsed, testing_iterations, scene : ArticulatedScene, renderFunc, renderArgs, train_test_exp):
    if tb_writer:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[5, 5_000, 10_000, 20_000, 30_000, 40_000, 50_000, 70_000, 100_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[5, 5_000, 10_000, 20_000, 30_000, 40_000, 50_000, 70_000, 100_000])
